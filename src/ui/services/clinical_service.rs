...
impl ClinicalUiService {
    ...
    pub async fn add_allergy(
        ...
        patient_id: Uuid,
        allergen: String,
        allergy_type: crate::domain::clinical::AllergyType,
        severity: Severity,
    ...
    pub async fn update_social_history(
        &self,
        patient_id: Uuid,
        smoking_status: crate::domain::clinical::SmokingStatus,
        cigarettes_per_day: Option<u8>,
        smoking_quit_date: Option<chrono::NaiveDate>,
        alcohol_status: crate::domain::clinical::AlcoholStatus,
        standard_drinks_per_week: Option<u8>,
        exercise_frequency: Option<crate::domain::clinical::ExerciseFrequency>,
