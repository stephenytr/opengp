...
mod tests {
    ...
    fn test_allergy_counts() {
        ...
        let active_allergy = Allergy {
            ...
            allergy_type: crate::domain::clinical::AllergyType::Drug,
            severity: crate::domain::clinical::Severity::Severe,
        ...
        let inactive_allergy = Allergy {
            ...
            allergy_type: crate::domain::clinical::AllergyType::Food,
            severity: crate::domain::clinical::Severity::Moderate,
    ...
    fn test_condition_counts() {
        ...
        let active_condition = MedicalHistory {
            ...
            diagnosis_date: None,
            status: crate::domain::clinical::ConditionStatus::Active,
            severity: Some(crate::domain::clinical::Severity::Moderate),
            notes: None,
            is_active: true,
            created_at: Utc::now(),
            updated_at: Utc::now(),
        ...
        let resolved_condition = MedicalHistory {
            ...
            diagnosis_date: None,
            status: crate::domain::clinical::ConditionStatus::Resolved,
            severity: None,
            notes: None,
            is_active: false,
            created_at: Utc::now(),
