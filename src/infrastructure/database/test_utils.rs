...
use crate::domain::appointment::{Appointment, AppointmentType};
use crate::domain::patient::{Address, Gender, NewPatientData, Patient};
...
/// # Example
/// ```no_run
/// use opengp::infrastructure::database::test_utils::create_test_pool;
///
/// # #[tokio::main]
...
/// # Example
/// ```
/// use opengp::infrastructure::database::test_utils::create_test_patient;
///
...
/// # Example
/// ```
/// use opengp::infrastructure::database::test_utils::create_test_appointment;
///
/// let appointment = create_test_appointment();
/// assert_eq!(appointment.appointment_type, opengp::domain::appointment::model::AppointmentType::Standard);
